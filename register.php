...
<div id="form-1">
    ...
    <div class="form">
        <form name="myform2" id="form" action="user_register_process.php" method="POST" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="uname1" id="username" placeholder="Enter Username" required>
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" name="upswd1" placeholder="Enter Password" id="password" required>
                <small id="password-error" class="error-message"></small>
            </div>
            <div class="form-group">
                <label for="password2"><b>Re-Enter Password:</b></label>
                <input type="password" class="form-control" name="upswd2" placeholder="Re-Enter Password" id="password2" required>
            ...
            <div class="link-div">
               <center><a href="login.php" class="link-div1"><b>Existing Admin? Login!</b></a></center> 
            </div>
        </form>
    </div>
</div>
